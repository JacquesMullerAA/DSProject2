...
model = pickle.load(bz2.BZ2File("../models/classifier.pbz2",'rb'))
...
# extract data needed for visuals
    ...
    cat_df = (cat_df.sort_values(ascending=False)[0:15])
    cat_names = list(cat_df.index)
    cat_fractions = list(cat_df.values)
